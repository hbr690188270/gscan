...
from seq2seq.train import pad_train, train
from seq2seq.predict import (predict_and_save, predict_and_save_beamsearch, predict_and_save_noeos, predict_and_save_pad, predict_and_save_transformer, 
...
parser.add_argument("--insertion", type=str, default='start', choices=['start', 'mid'],)
parser.add_argument("--max_white_num", type=int, default=100)
...
def main(flags):
    ...
    if flags["mode"] == "train":
        pad_train(data_path=data_path, **flags)
        ...
        for split in splits:
            ...
            output_file = predict_and_save_pad(dataset=test_set, model=model, output_file_path=output_file_path, **flags)
