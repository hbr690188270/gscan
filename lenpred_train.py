...
from seq2seq.my_model import PredNet, PredNetTransformer, PredNetTransformerV2
from seq2seq.train import train, pred_net_train
from seq2seq.predict import predict_and_save, predict_and_save_noeos, predict_and_save_transformer, predict_and_save_noeos_transformer
...
parser.add_argument("--model_type", type=str, default='orig',)
parser.add_argument("--inf_type", type=str, default='orig', )
...
def main(flags):
    ...
    if flags["mode"] == "train":
        pred_net_train(data_path=data_path, **flags)
        ...
        for split in splits:
            ...
            if flags['model_type'] == 'transformer':
                model = PredNetTransformer(input_vocabulary_size=test_set.input_vocabulary_size,
                                        ...
                                        **flags)        
            elif flags['model_type'] == 'transformer_v2':
