...
from seq2seq.train import train, withlen_train
from seq2seq.predict import (predict_and_save, predict_and_save_noeos, predict_and_save_transformer, 
                                predict_and_save_noeos_transformer, predict_withlenbias, predict_withlenbias_and_save)
...
def main(flags):
    ...
    if flags["mode"] == "train":
        withlen_train(data_path=data_path, **flags)
        ...
        for split in splits:
            ...
            model = ModelWithLengthBias(input_vocabulary_size=test_set.input_vocabulary_size,
            ...
            output_file = predict_withlenbias_and_save(dataset=test_set, model=model, output_file_path=output_file_path, **flags)
